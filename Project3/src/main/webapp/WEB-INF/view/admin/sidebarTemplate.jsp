   ...
   <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
      ...
      <div class="panel panel-default">
         ...
         <div id="collapse2" class="panel-collapse collapse" role="tabpanel">
            <div class="panel-body text-center"><a class="text-muted text-decoration-none" href="${pageContext.request.contextPath }/adminReviewList.do"><strong>상품 후기 조회</strong></a></div>
            <div class="panel-body text-center"><a class="text-muted text-decoration-none" href="${pageContext.request.contextPath }/adminProductQnaList.do"><strong>상품 문의 조회</strong></a></div>
         </div>
      </div>
      <div class="panel panel-default">
