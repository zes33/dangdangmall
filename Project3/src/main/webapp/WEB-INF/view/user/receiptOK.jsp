...
<!-- header -->
	<header>
		...
		<div class="card border-success mb-3" style="max-width: 30rem; max-width: 600px; margin-left: 350px;">
		  <div class="card-header"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;"><div class="text-center h4"><div class="center"><strong>환불 신청</strong>이 완료되었습니다</div>
		  </div><hr>
