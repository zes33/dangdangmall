	...
	<main>
		...
		<div class="album py-5 bg-light">
			<div class="container">
				...
				<div class="cat">
					<a class="categoryName" href="#">새벽배송 </a><br>
				</div>
										...
										<div>
											<c:choose>
												<c:when test="${0 eq food.product_discount }">
													<span class="testcost">
														<!-- 원가 --> <fmt:formatNumber
															value="${food.product_price }" pattern="#,###" />
													</span>
												...
												<c:otherwise>
													<span class="testdcPrice">
														<!-- 할인가 --> <fmt:formatNumber
															value="${food.product_price * (1- food.product_discount) }"
															pattern="#,###" />
													</span>
													<span class="won">원</span>
													<span> <strike class="testPct"> <fmt:formatNumber
																value="${food.product_price }" pattern="#,###" />원
													</strike>
													</span>
													<span class="testdiscountPct"> <fmt:formatNumber
															value="${food.product_discount * 100}" pattern="#,###" />%
													</span>
												</c:otherwise>
											</c:choose>
										</div>
										...
										<div>
											<c:choose>
												<c:when test="${0 eq exercise.product_discount }">
													<span class="testcost">
														<!-- 원가 --> <fmt:formatNumber
															value="${exercise.product_price }" pattern="#,###" />
													</span>
													<span class="won">원</span>
												</c:when>
												<c:otherwise>
													<span class="testdcPrice">
														<!-- 할인가 --> <fmt:formatNumber
															value="${exercise.product_price * (1- exercise.product_discount) }"
															pattern="#,###" />
													</span>
													<span class="won">원</span>
													<span> <strike class="testPct"> <fmt:formatNumber
																value="${exercise.product_price }" pattern="#,###" />원
													</strike>
													</span>
													<span class="testdiscountPct"> <fmt:formatNumber
															value="${exercise.product_discount * 100}"
															pattern="#,###" />%
													</span>
